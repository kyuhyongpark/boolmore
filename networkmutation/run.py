...
# BASE = 'PyStableMotifs/models/ABA_ca_two.txt'
BASE = 'PyStableMotifs/models/ABA_full_fix_mod2.txt'
...
# MODEL = 'PyStableMotifs/models/ABA_calosc_mod.txt'
# MODEL = 'PyStableMotifs/models/ABA_ca_two.txt'
MODEL = 'PyStableMotifs/models/ABA_full_fix_mod2.txt'
